...
- 88.9% of the survey respondents reported to at least of the minority service or leadership criteria. 
...
# Display histogram
hist(eco_purchase, main = NULL, xlab = "spending (dollars)")
...
# Display histogram
hist(eco_storage, main = NULL, xlab = "spending (dollars)")
...
# Display histogram
hist(eco_maintain, main = NULL, xlab = "spending (dollars)")
...
# Display histogram
hist(eco_totalcost, main = NULL, xlab = "spending (dollars)")
...
# Display histogram
hist(eco_events, main = NULL, xlab = "count of events")
...
# Display histogram
hist(eco_nothost, main = NULL, xlab = "count of events")
...
# Display histogram
hist(eco_nothost_pct_calc*100, main = NULL, xlab = "Percentage(%)")
...
**Figure 21: Dist of negatively impacted constituents if TB did not exist (past year)**
...
# Display histogram
hist(eco_constit, main = NULL, xlab = "count")
...
**Figures 22a-d: Dist of events possible through TB by minority status**
...
sum_table[,-c(1)] %>% addHtmlTableStyle(col.columns = c("none", "#F7F7F7",
                                    "none", "#F7F7F7",
                                    "none", "#F7F7F7")) %>% 
  htmlTable(header =  c("Frequency", "Percentage"),
            rnames = c("Quantity",
                       "Quality",
                       "Diversity",
                       "Consistency",
...
ggplot(sum_table)+
  geom_bar(aes(x = choices, y = percentage), stat='identity') +
  labs(x = "event types TB helps to complete", y = "percentage responded", title = NULL) +
  ylim(c(0,1))
...
sum_table%>% 
  ...
  htmlTable(header =  c("Mean","25th quantile", "Median", "Mode","75th quantile","Standard deviation"),
            ...
            caption = "Table 8: Event expense budget was saved by using TB equipment")
```
