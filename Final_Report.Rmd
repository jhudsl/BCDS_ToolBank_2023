...
sum_table = data.frame(choices = c("Quantity",
                       ...
                       percentage = c(paste0(round(
                         as.numeric(nrow(data[data$ci_evimpact_qtt == 1,])/nrow(data),1)*100
                         ),"%"),
                                            paste0(round(
                         as.numeric(nrow(data[data$ci_evimpact_qlt == 1,])/nrow(data),1)*100
                         ),"%"),
                                           paste0(round(
                         as.numeric(nrow(data[data$ci_evimpact_dvt == 1,])/nrow(data),1)*100
                         ),"%"),
                                            paste0(round(
                         as.numeric(nrow(data[data$ci_evimpact_cst == 1,])/nrow(data),1)*100
                         ),"%"),
                                            paste0(round(
                         as.numeric(nrow(data[!is.na(data$ci_evimpact_otr),])/nrow(data),1)*100
                         ),"%")))
...
sum_table = data.frame(choices = c("Fundraising",
                       ...
                       percentage = c(
                         paste0(round(
                           nrow(data[data$eve_type_fr == 1,])/nrow(data)*100,1),"%"),
                                            paste0(round(
                                              nrow(data[data$eve_type_sp == 1,])/nrow(data)*100,1),"%"),
                                            paste0(round(
                                              nrow(data[data$eve_type_ew == 1,])/nrow(data)*100,1),"%"),
                                            paste0(round(
                                              nrow(data[data$eve_type_cb == 1,])/nrow(data)*100,1),"%"),
                                            paste0(round(
                                              nrow(data[!is.na(data$eve_type_otr),])/nrow(data)*100,1),"%")))
